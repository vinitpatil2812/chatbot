...
intents = json.loads(open('D:\ChatBot\intent.json').read())
...
pickle.dump(words,open('D:\ChatBot\intent.json\words.pkl','wb'))
pickle.dump(classes,open('D:\ChatBot\intent.json\classes.pkl','wb'))
# print(classes)
# print(words)
